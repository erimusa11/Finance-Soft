   ...
   <nav class="navbar navbar-expand-lg navbar-mainbg">
       <a class="navbar-brand navbar-logo" href="#">Menu</a>
       ...
       <div class="collapse navbar-collapse" id="navbarSupportedContent">
           <ul class="navbar-nav ml-auto">
               ...
               <li class="nav-item">
                   <a class="nav-link" href="user-create.php"><i class="fa fa-user"></i>Perdoruesit</a>
               </li>
               <li class="nav-item">
                   <a class="nav-link" href="add_product.php"><i class="fa fa-product-hunt"></i>Produktet
                   </a>
               </li>
               <li class="nav-item">
                   <a class="nav-link" href="add_category.php"><i class="fa fa-clone"></i>Kategorite</a>
               </li>
               <li class="nav-item">
                   <a class="nav-link" href="add_supplier.php"><i class="fa fa-industry"></i>Furnitoret</a>
               </li>
               <li class="nav-item ">
                   <a class="nav-link " href="update_products.php"><i class="fa fa-repeat"></i>Furnizimet</a>
               </li>
               <li class="nav-item">

...
(function (h) {
    ...
    function jb(a) {
        ...
        for (c = l.length; b < c; b++)
            (f = l[b]),
                ...
                i && d.appendTo(e),
                a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), La(a, f.nTh, b))),
    ...
    function tb(a) {
        ...
        for (g = 0; g < c; g++)
            (n = b[g]),
                ...
                pa.columns.push({ data: i, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: { value: l.sSearch, regex: l.bRegex } }),
                t("mDataProp_" + g, i),
    ...
    function Ea(a) {
        ...
        if (d || (!t && !f && !e && j == aa(a) && j == n.length)) for (m = 0; m < j; m++) (i = Z(a, m)), null !== i && (c[i].sWidth = v(n.eq(m).width()));
        else {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: { sFirst: "First", sLast: "Last", sNext: "Perpara", sPrevious: "Pas" },
            sEmptyTable: "Nuk ka te dhena ne tabele",
            sInfo: "Shfaqur _START_ deri ne _END_ nga _TOTAL_ elemente",
            sInfoEmpty: "Shfaqur 0 deri 0 nga 0 elemente",
            sInfoFiltered: "(Filtruar nga _MAX_ elemente totale)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Shfaq _MENU_ elemente",
            sLoadingRecords: "Po ngarkohen te dhenat...",
            sProcessing: "<div class='loader-box'><div class='loader-4'></div></div>",
            sSearch: "Kerko:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Nuk ka te dhena ne tabele",
        },
